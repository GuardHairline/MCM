# masc_2015
python -m scripts.train --task_name=masc --session_name=masc_1 --output_model_path=checkpoints/model_masc_15_n.pt --train_info_json=checkpoints/train_info_twitter2015_none_multi.json --num_labels=3 --lr=1e-5 --step_size=5 --gamma=0.5 --replay=0
# mate_2015
python -m scripts.train --task_name=mate --session_name=mate_1 --pretrained_model_path=checkpoints/model_masc_15_n.pt --output_model_path=checkpoints/model_mate_15_n.pt --num_labels=3 --train_info_json=checkpoints/train_info_twitter2015_none_multi.json --replay=0
# mner_2015
...
# mabsa_2015
python -m scripts.train --task_name=mabsa --session_name=mabsa_1 --pretrained_model_path=checkpoints/model_mner_15_n.pt --output_model_path=checkpoints/model_mabsa_15_n.pt --num_labels=7 --train_info_json=checkpoints/train_info_twitter2015_none_multi.json --replay=0 --epoch=20 --lr=5e-5 --step_size=10 --gamma=0.5
# mnre_2015
