...
# SERVER - ALL TASKS - TWITTER2017 - REPLAY - MULTIMODAL
# Experience Replay
...
PREV_MODEL=""
FINAL_MODEL="$CHECKPOINT_DIR/twitter2017_replay_multimodal.pt"
...
for (( ; i<${#TASKS[@]}; i++ )); do
    ...
    TRAIN_INFO_PATH="$CHECKPOINT_DIR/train_info_twitter2017_replay_multimodal.json"
    LOG_FILE="$LOG_DIR/$TASK_NAME_twitter2017_replay_multimodal.log"
