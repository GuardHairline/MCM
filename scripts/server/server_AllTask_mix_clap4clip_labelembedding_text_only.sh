...
# SERVER - ALL TASKS - MIX - CLAP4CLIP_LABELEMBEDDING - TEXT_ONLY
...
PREV_MODEL=""
FINAL_MODEL="$CHECKPOINT_DIR/mix_clap4clip_labelembedding_text_only.pt"
...
for (( ; i<${#TASKS[@]}; i++ )); do
    ...
    TRAIN_INFO_PATH="$CHECKPOINT_DIR/train_info_mix_clap4clip_labelembedding_text_only.json"
    LOG_FILE="$LOG_DIR/$TASK_NAME_mix_clap4clip_labelembedding_text_only.log"
