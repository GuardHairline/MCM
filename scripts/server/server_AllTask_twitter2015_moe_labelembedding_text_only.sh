...
# SERVER - ALL TASKS - TWITTER2015 - MOE_LABELEMBEDDING - TEXT_ONLY
# MoE + Label Embedding
...
PREV_MODEL=""
FINAL_MODEL="$CHECKPOINT_DIR/twitter2015_moe_labelembedding_text_only.pt"
...
for (( ; i<${#TASKS[@]}; i++ )); do
    ...
    TRAIN_INFO_PATH="$CHECKPOINT_DIR/train_info_twitter2015_moe_labelembedding_text_only.json"
    LOG_FILE="$LOG_DIR/$TASK_NAME_twitter2015_moe_labelembedding_text_only.log"
