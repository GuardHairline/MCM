...
# SERVER - ALL TASKS - MIX - LABELEMBEDDING - TEXT_ONLY
# Label Embedding
...
PREV_MODEL=""
FINAL_MODEL="$CHECKPOINT_DIR/mix_labelembedding_text_only.pt"
...
for (( ; i<${#TASKS[@]}; i++ )); do
    ...
    TRAIN_INFO_PATH="$CHECKPOINT_DIR/train_info_mix_labelembedding_text_only.json"
    LOG_FILE="$LOG_DIR/$TASK_NAME_mix_labelembedding_text_only.log"
