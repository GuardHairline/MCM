# masc_2015
python -m scripts.train --task_name=masc --session_name=masc_1 --output_model_path=checkpoints/model_masc_15_n.pt --train_info_json=checkpoints/train_info_twitter2015_none_text.json --num_labels=3 --mode=text_only --lr=1e-5 --step_size=5 --gamma=0.5 --replay=0
# mate_2015
