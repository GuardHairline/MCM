# masc
python -m scripts.train --task_name=masc --num_labels=3 --session_name=masc_1 --mode=text_only --train_info_json=checkpoints/train_info_twitter2015_none_text.json --replay=1
# mate
python -m scripts.train --task_name=mate --session_name=mate_1 --pretrained_model_path=checkpoints/model_1.pt --output_model_path=checkpoints/model_mate.pt --num_labels=3 --epochs=5 --lr=1e-5 --mode=text_only --train_info_json=checkpoints/train_info_twitter2015_none_text.json --replay=1
# mner
...
# mabsa
python -m scripts.train --task_name=mabsa --session_name=mabsa_1 --pretrained_model_path=checkpoints/model_mnre.pt --output_model_path=checkpoints/model_mabsa.pt --num_labels=7 --mode=text_only --train_info_json=checkpoints/train_info_twitter2015_none_text.json --replay=1