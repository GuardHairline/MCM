...
# LOCAL - ALL TASKS - 200 - LWF - MULTIMODAL
...
PREV_MODEL=""
FINAL_MODEL="$CHECKPOINT_DIR/200_lwf_multimodal.pt"
...
for (( ; i<${#TASKS[@]}; i++ )); do
    ...
    TRAIN_INFO_PATH="$CHECKPOINT_DIR/train_info_200_lwf_multimodal.json"
    LOG_FILE="$LOG_DIR/$TASK_NAME_200_lwf_multimodal.log"
