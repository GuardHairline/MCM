...
# LOCAL - ALL TASKS - 200 - SI - TEXT_ONLY
...
PREV_MODEL=""
FINAL_MODEL="$CHECKPOINT_DIR/200_si_text_only.pt"
...
for (( ; i<${#TASKS[@]}; i++ )); do
    ...
    TRAIN_INFO_PATH="$CHECKPOINT_DIR/train_info_200_si_text_only.json"
    LOG_FILE="$LOG_DIR/$TASK_NAME_200_si_text_only.log"
