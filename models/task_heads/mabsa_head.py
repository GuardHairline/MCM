...
class MABSAHead(nn.Module):
    def __init__(self, input_dim, num_labels=7, dropout_prob=0.1):
        """
        ...
        self.fc = nn.Linear(input_dim, input_dim)  # 增加一个线性层来调整特征维度
        self.relu = nn.ReLU()
        self.classifier = nn.Linear(input_dim, num_labels)  # 分类器输出7个标签
