...
def process_data(input_lines):
    ...
    # 实体类别映射
    entity_map = {"PER": "-1", "ORG": "0", "LOC": "1", "OTHER": "2", "MISC": "3"}

    for line in input_lines:
        if line.startswith("IMGID:"):
            # 如果有前面的数据，处理前一组
            if img_id is not None:
                print(f"处理图片 {img_id}, 文本{''.join(current_text)}")
...
# 调用函数读取文件并保存结果
input_file1 = "ori_train.txt"
output_file1 = "train.txt"
process_data_file(input_file1, output_file1)
input_file2 = "ori_test.txt"
output_file2 = "test.txt"
process_data_file(input_file2, output_file2)
input_file3 = "ori_dev.txt"
output_file3 = "dev.txt"
process_data_file(input_file3, output_file3)